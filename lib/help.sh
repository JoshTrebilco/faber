...
declare -A HELP_SYNOPSIS=(
    ...
    ["app:show"]="cipi app show <user>"
    ["app:edit"]="cipi app edit <user> [options]"
    ["app:env"]="cipi app env <user>"
    ["app:crontab"]="cipi app crontab <user>"
    ["app:password"]="cipi app password <user>"
    ["app:delete"]="cipi app delete <user>"
    ["app:rollback"]="cipi app rollback <user> [release]"
    ["app:releases"]="cipi app releases <user>"
    ["domain"]="cipi domain <command> [options]"
    ["domain:create"]="cipi domain create [options]"
    ["domain:list"]="cipi domain list"
    ["domain:delete"]="cipi domain delete <domain>"
    ["database"]="cipi database <command> [options]"
    ["database:create"]="cipi database create [options]"
    ["database:list"]="cipi database list"
    ["database:password"]="cipi database password <name>"
    ["database:delete"]="cipi database delete <name>"
    ["php"]="cipi php <command> [options]"
    ["php:list"]="cipi php list"
    ["php:install"]="cipi php install <version>"
    ["php:switch"]="cipi php switch <version>"
    ["service"]="cipi service <command> [options]"
    ["service:restart"]="cipi service restart <service>"
    ["webhook"]="cipi webhook <command> [options]"
    ["webhook:setup"]="cipi webhook setup <user>"
    ["webhook:show"]="cipi webhook show <user>"
    ["webhook:regenerate"]="cipi webhook regenerate <user>"
    ["webhook:delete"]="cipi webhook delete <user>"
    ["webhook:logs"]="cipi webhook logs"
    ["reverb"]="cipi reverb <command> [options]"
    ["reverb:setup"]="cipi reverb setup"
    ["reverb:show"]="cipi reverb show"
    ["reverb:start"]="cipi reverb start"
    ["reverb:stop"]="cipi reverb stop"
...
declare -A HELP_DESCRIPTION=(
    ...
    ["webhook:setup"]="Create webhook on GitHub"
    ...
    ["update"]="Update Cipi to latest version"
)
...
show_help_compact() {
    ...
    echo ""
    echo -e "Run ${CYAN}cipi help${NC} for full documentation"
    echo -e "Run ${CYAN}cipi <command> --help${NC} for command details"
    echo -e "Run ${CYAN}cipi help -i${NC} for interactive mode"
    echo ""
}
...
show_help_full() {
    ...
    echo -e "  ${CYAN}webhook setup <user>${NC}             Create webhook on GitHub"
    ...
    echo -e "  ${CYAN}reverb setup${NC}                    Set up dedicated Reverb WebSocket server"
    ...
    echo -e "  cipi domain create --domain=example.com --app=myapp"
...
show_help_command() {
    ...
    case "$cmd" in
        status)
            ...
            ;;
        version)
            echo -e "${BOLD}VERSION${NC} - Show Cipi version"
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi version${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        app)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            ...
            echo ""
            echo -e "Run ${CYAN}cipi app <command> --help${NC} for command options"
            echo ""
            ;;
        domain)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi domain <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            ...
            echo ""
            echo -e "Run ${CYAN}cipi domain <command> --help${NC} for command options"
            echo ""
            ;;
        database)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi database <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            ...
            echo ""
            echo -e "Run ${CYAN}cipi database <command> --help${NC} for command options"
            echo ""
            ;;
        php)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi php <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            ...
            echo ""
            echo -e "Run ${CYAN}cipi php <command> --help${NC} for command options"
            echo ""
            ;;
        service)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi service <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            echo -e "  ${CYAN}restart${NC}    Restart a service"
            echo ""
            echo -e "Run ${CYAN}cipi service restart --help${NC} for details"
            echo ""
            ;;
        webhook)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            echo -e "  ${CYAN}setup${NC}       Create webhook on GitHub"
            ...
            echo ""
            echo -e "Run ${CYAN}cipi webhook <command> --help${NC} for command options"
            echo ""
            ;;
        reverb)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb <command> [options]${NC}"
            echo ""
            echo -e "${BOLD}COMMANDS:${NC}"
            echo -e "  ${CYAN}setup${NC}      Set up dedicated Reverb server"
        ...
        logs)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi logs [--lines=N]${NC}"
            echo ""
        ...
        *)
            ...
            echo -e "Run ${CYAN}cipi help${NC} for available commands."
            echo ""
            return 1
            ;;
    esac
...
show_help_subcommand() {
    ...
    case "$cmd:$subcmd" in
        ...
        app:create)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app create [options]${NC}"
            echo ""
            echo -e "${BOLD}REQUIRED:${NC}"
            echo -e "  ${CYAN}--user=<name>${NC}           System username (lowercase, alphanumeric)"
            echo -e "  ${CYAN}--repository=<url>${NC}     Git repository URL (HTTPS or SSH)"
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi app create"
            echo -e "  cipi app create --user=mysite --repository=https://github.com/user/repo.git"
            echo -e "  cipi app create --user=mysite --repository=git@github.com:user/repo.git --php=8.3 --branch=develop"
            echo ""
            ;;
        app:list)
        ...
        app:show)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app show <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi app show myapp"
            echo ""
            ;;
        app:edit)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app edit <user> [options]${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
        ...
        app:env)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app env <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
        ...
        app:crontab)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app crontab <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
        ...
        app:password)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app password <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
        ...
        app:delete)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app delete <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
        ...
        app:rollback)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app rollback <user> [release]${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi app rollback myapp"
            echo -e "  cipi app rollback myapp 20260105120000"
            echo ""
            ;;
        app:releases)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi app releases <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi app releases myapp"
            echo ""
            ;;
        domain:create)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi domain create [options]${NC}"
            echo ""
            echo -e "${BOLD}REQUIRED:${NC}"
            echo -e "  ${CYAN}--domain=<domain>${NC}        Domain name"
        ...
        domain:list)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi domain list${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        domain:delete)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi domain delete <domain>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<domain>${NC}                Domain name to delete"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi domain delete example.com"
            echo ""
            ;;
        database:create)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi database create [options]${NC}"
            echo ""
            echo -e "${BOLD}OPTIONAL:${NC}"
            echo -e "  ${CYAN}--name=<name>${NC}           Database name (auto-generated if not provided)"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi database create"
            echo -e "  cipi database create --name=mydb"
            echo ""
            ;;
        database:list)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi database list${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        database:password)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi database password <name>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
        ...
        database:delete)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi database delete <name>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<name>${NC}                  Database name"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi database delete mydb"
            echo ""
            ;;
        php:list)
        ...
        php:install)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi php install <version>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<version>${NC}               PHP version (5.6-8.5)"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi php install 8.3"
            echo -e "  cipi php install 8.4"
            echo ""
            ;;
        php:switch)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi php switch <version>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<version>${NC}               PHP version to switch to"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi php switch 8.3"
            echo ""
            ;;
        service:restart)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi service restart <service>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<service>${NC}                Service name (nginx|php|mysql|supervisor|redis)"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi service restart nginx"
            echo -e "  cipi service restart mysql"
            echo ""
            ;;
        webhook:setup)
            echo -e "${BOLD}WEBHOOK SETUP${NC} - Create webhook on GitHub"
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook setup <user>${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi webhook setup myapp"
            echo ""
            ;;
        webhook:show)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook show <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi webhook show myapp"
            echo ""
            ;;
        webhook:regenerate)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook regenerate <user>${NC}"
            echo ""
            echo -e "${BOLD}ARGUMENTS:${NC}"
            echo -e "  ${CYAN}<user>${NC}                  Application username"
            echo ""
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi webhook regenerate myapp"
            echo ""
            ;;
        webhook:delete)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook delete <user>${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi webhook delete myapp"
            echo ""
            ;;
        webhook:logs)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook logs${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
            ...
            ;;
        reverb:setup)
            echo -e "${BOLD}REVERB SETUP${NC} - Set up Reverb WebSocket server"
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb setup${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
            echo -e "  Sets up a dedicated Reverb WebSocket server for Laravel applications."
            echo ""
            ;;
        reverb:show)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb show${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        reverb:start)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb start${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        reverb:stop)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb stop${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        reverb:restart)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb restart${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        reverb:delete)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb delete${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
        ...
        *)
            ...
            echo ""
            echo -e "Run ${CYAN}cipi $cmd --help${NC} for available subcommands."
            echo ""
            return 1
            ;;
    esac
