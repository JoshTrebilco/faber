...
declare -A HELP_SYNOPSIS=(
    ...
    ["webhook:create"]="cipi webhook create <user>"
    ...
    ["reverb:create"]="cipi reverb create"
...
show_help_subcommand() {
    ...
    case "$cmd:$subcmd" in
        ...
        webhook:create)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi webhook create <user>${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
            ...
            echo ""
            echo -e "${BOLD}EXAMPLES:${NC}"
            echo -e "  cipi webhook create myapp"
            echo ""
            ;;
        webhook:show)
        ...
        reverb:create)
            ...
            echo ""
            echo -e "${BOLD}USAGE:${NC}"
            echo -e "  ${CYAN}cipi reverb create${NC}"
            echo ""
            echo -e "${BOLD}DESCRIPTION:${NC}"
